...
function ContactInfo() {
  return (
    <div className="justify-center items-center mx-0 flex flex-col mb-10 w-4/5 contactMe min-h-9/10">
      ...
      <p className="text-lg mb-1 text-center ">Want to find out more? Download is my <a href="path/to/file.ext" download rel="noopener noreferrer" target="_blank" className="hover:text-sky" >resume</a>.</p>
